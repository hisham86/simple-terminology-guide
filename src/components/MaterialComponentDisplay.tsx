...
import { MaterialComponent } from "@/data/materialComponents";
import { ExternalLink } from "lucide-react";

interface MaterialComponentDisplayProps {
  component: MaterialComponent;
  className?: string;
}

const MaterialComponentDisplay: React.FC<MaterialComponentDisplayProps> = ({ 
  component, 
  className
}) => {
...
export default MaterialComponentDisplay;
